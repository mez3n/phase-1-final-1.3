...
int main()
{
	...
	pIn->GetPointClicked(x,y);	//Wait for any click
	// 2.3.1 - Drawing non-filled rectangle
	...
	do
	{
		...
		case FIGURE_TYPE_ACT:
			pOut->PrintMessage("Action: a click on the pick by figure type icon, Click anywhere");
			break;


		case FIGURE_FILL_COLOR_ACT:
			pOut->PrintMessage("Action: a click on the pick by color icon, Click anywhere");
			break;


		case FIGURE_TYPE_COLOR_ACT:
			pOut->PrintMessage("Action: a click on the pick by figure type and color icon, Click anywhere");
			break;


		case SELECT_ONE_ACT:
			pOut->PrintMessage("Action: a click on the select figure icon, Click anywhere");
			break;


		case CHANGE_COLOR_ACT:
			pOut->PrintMessage("Action: a click on the change color icon, Click anywhere");
			break;


		case DELETE_ACT:
			pOut->PrintMessage("Action: a click on the delete figure icon, Click anywhere");
			break;


		case MOVE_ACT:
			pOut->PrintMessage("Action: a click on the move figure icon, Click anywhere");
			break;


		case UNDO_ACT:
			pOut->PrintMessage("Action: a click on the undo icon, Click anywhere");
			break;


		case REDO_ACT:
			pOut->PrintMessage("Action: a click on the redo icon, Click anywhere");
			break;


		case CLEAR_ALL_ACT:
			pOut->PrintMessage("Action: a click on the clear all icon, Click anywhere");
			break;


		case START_RECORD_ACT:
			pOut->PrintMessage("Action: a click on the start recording icon, Click anywhere");
			break;



		case STOP_RECORD_ACT:
			pOut->PrintMessage("Action: a click on the stop recording icon, Click anywhere");
			break;



		case PLAY_RECORD_ACT:
			pOut->PrintMessage("Action: a click on the play recording icon, Click anywhere");
			break;



		case SAVE_ACT:
			pOut->PrintMessage("Action: a click on the save icon , Click anywhere");
			break;



		case LOAD_ACT:
			pOut->PrintMessage("Action: a click on the load icon, Click anywhere");
			break;
